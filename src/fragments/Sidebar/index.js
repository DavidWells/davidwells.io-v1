    ...
    <div className={styles.sidebar}>
      <div className={styles.sidebarFixed}>
        ...
        <ul className={styles.icons}>
          <li>
            <a href='https://github.com/davidwells' target='_blank' rel='nofollow noopener noreferrer' aria-label='GitHub'>
          ...
          <li>
            <a href='https://www.linkedin.com/in/davidgwells' target='_blank' rel='nofollow noopener noreferrer' aria-label='Linkedin'>
          ...
          {/*
            <li>
            <a href="https://codepen.io/davidwells" target="_blank" rel="nofollow noopener noreferrer" aria-label="Codepen">
            <svg xmlns="http://www.w3.org/2000/svg" role="img" viewBox="0 0 31.665 31.665"><title>Codepen</title>
          ...
          */}
          <li>
            <a href='https://twitter.com/davidwells' target='_blank' rel='nofollow noopener noreferrer' aria-label='Twitter'>
